...
const STAGES: Stage[] = [
	...
	},
	{
		...
		text: "Attempts to preserve the old order",
		date: "1641–1642 · Royal declarations",
	},
	{
		title: "Meeting the Mentor",
		text: "New models of political authority emerge",
		date: "1642–1644 · Newsbooks & pamphlets",
	},
	{
		title: "Crossing the Threshold",
		text: "Civil war transforms the political order",
		date: "1642–1645 · Ordinances",
	},
	{
	...
	},
	{
		...
		text: "The sovereignty of the king is challenged",
		date: "1648 · Army remonstrances",
	},
	{
		title: "Ordeal",
		text: "Trial and execution of Charles I",
		date: "1649 · High Court & regicide",
	},
	{
		title: "Reward",
		text: "The body politic reconstituted as Commonwealth",
	...
	{
		title: "Resurrection",
		text: "The sovereignty question returns",
...
export default function HeroJourneyCircle(props: Props) {
	...
	return (
		<svg viewBox={`0 0 ${width()} ${height()}`} width="100%" height="100%">
			<title>The Hero's Journey of the British Body Politic</title>
			<defs>
				<style>
					{`
                    .line {
			...
			<circle cx={cx()} cy={cy()} r="0" fill="currentColor" />
			...
			<For each={nodes()}>
				{(node) => (
					<g>
						...
						>
							<text class="title" x={node.x} y={node.y - 18}>
								{node.title}
							</text>

							<text class="text" x={node.x} y={node.y + 8}>
								{node.text}
							</text>

							<text class="date" x={node.x} y={node.y + 30}>
								{node.date}
							</text>
						</g>
					</g>
